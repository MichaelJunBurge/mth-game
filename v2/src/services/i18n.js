...
export const I18N = {
  en: {
    ...
    "rules": [
      ...
      "Swipe left/right (or use the side arrows) to move between calculators — swipe past the last to add a new one. The sketchpad is on the far left.",
    ...
    "walk": [
      ...
      "These dots are your pages. Swipe left/right to switch calculators — or reach the sketchpad on the far left.",
      "Swipe up for help, swipe down for the menu — on any page. Submit ends the round once all six numbers are used.",
  ...
  ko: {
    ...
    "rules": [
      ...
      "좌우로 스와이프(또는 화살표)하면 계산기를 넘기고, 마지막에서 더 넘기면 새 계산기가 생깁니다. 맨 왼쪽은 스케치패드입니다.",
    ...
    "walk": [
      ...
      "이 점들은 페이지입니다. 좌우로 스와이프해 계산기를 넘기거나 맨 왼쪽 스케치패드로 가세요.",
      "어느 페이지에서든 위로 스와이프하면 도움말, 아래로 스와이프하면 메뉴가 열립니다. 숫자를 모두 쓰면 제출로 끝낼 수 있어요.",
